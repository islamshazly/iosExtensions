...
extension UIColor {
    ...
    open class var activeIcon: UIColor { return UIColor(red: 213 / 255.0, green: 0 / 255.0, blue: 0 / 255.0, alpha: 1)}
    
    open class var bRed: UIColor { return UIColor(red: 213 / 255.0, green: 0 / 255.0, blue: 0 / 255.0, alpha: 1)}

    open class var bliteRed: UIColor { return UIColor(red: 146 / 255.0, green: 42 / 255.0, blue: 142 / 255.0, alpha: 0.5)}
    
    open class var inActiveIcon: UIColor { return UIColor(red: 96 / 255.0, green: 103 / 255.0, blue: 112 / 255.0, alpha: 1)}
    
    open class var bPurpel: UIColor { return UIColor(red: 146 / 255.0, green: 42 / 255.0, blue: 142 / 255.0, alpha: 1) }
    
        open class var unReadNotification: UIColor { return UIColor(red: 228 / 255.0, green: 30 / 255.0, blue: 38 / 255.0, alpha: 0.04) }
