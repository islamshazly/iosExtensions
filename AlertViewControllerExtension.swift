...
extension UIAlertController {
    ...
    class func ShowAlert(VC : UIViewController , error : TError , action : SetErrorAction?)
    {
        ...
        alert.addAction(UIAlertAction(title: "ok".localized, style: UIAlertActionStyle.default, handler: action))
    ...
    class func ShowWarrning(VC : UIViewController , message : String , action : SetErrorAction?)
    {
        ...
        alert.addAction(UIAlertAction(title: "yes".localized, style: UIAlertActionStyle.default, handler: action))
    ...
    class func ShowWarrning(VC : UIViewController , message : String , action : SetErrorAction? , cancelAction : SetErrorAction?)
    {
        ...
        alert.addAction(UIAlertAction(title: "yes".localized, style: UIAlertActionStyle.default, handler: action))
        alert.addAction(UIAlertAction(title: "no".localized, style: .cancel, handler: cancelAction))
        VC.present(alert, animated: true, completion: nil)
    }
    ...
    {
        let alert = UIAlertController(title: "", message: "warning_delete_item".localized, preferredStyle: UIAlertControllerStyle.alert)
